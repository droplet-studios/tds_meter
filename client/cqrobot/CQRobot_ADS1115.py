"""
Code adapted from http://www.cqrobot.wiki/index.php/TDS_(Total_Dissolved_Solids)_Meter_Sensor_SKU:_CQRSENTDS01 
"""

# import smbus
from circuitpython_adapter import not_SMBus as smbus # replace smbus with 'adapter' to use with Circuit Python
import time
